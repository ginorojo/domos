...
export default function DomosGeodesicosDemo() {
  ...
  const handleAgendar = (e: React.FormEvent) => {
    ...
    if (
      ...
      alert(
        "Por favor, completa los campos requeridos (Nombre, Teléfono, Día y Horario).",
      );
      return;
    }
  ...
  return (
    <main className="relative min-h-screen bg-stone-50 font-sans text-stone-900 overflow-hidden scroll-smooth">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <img
          src="/hero1.png"
          alt="Domos geodésicos para Glamping"
          className="absolute inset-0 z-0 w-full h-full object-cover brightness-[0.45]"
        />

        {/* Overlay de gradiente opcional para mejorar lectura (descomenta si quieres) */}
        ...
        >
          <h1 className="text-4xl md:text-7xl font-bold text-white mb-6 md:mb-8 leading-tight drop-shadow-2xl flex flex-wrap justify-center gap-x-4 md:gap-x-6 ">
            {["Desconecta"].map((word, i) => (
              <motion.span
                key={i}
                variants={fadeInUp}
            ...
            {["del", "Ruido,", "Conecta con tu"].map((word, i) => (
              <motion.span
                key={i + 3}
                variants={fadeInUp}
            ...
            {["Inversión"].map((word, i) => (
              <motion.span
                key={i + 6}
                variants={fadeInUp}
                className="inline-block text-white w-full md:w-auto"
              >
                {word}
              </motion.span>
            ))}
          ...
          >
            Domos geodésicos de alta eficiencia para Glamping.{" "}
            <br className="hidden md:block" />
            El refugio perfecto que{" "}
            <strong className="font-bold text-white">se paga solo.</strong>
          </motion.p>
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="inline-block bg-emerald-500 text-white w-full md:w-auto px-8 md:px-10 py-4 md:py-5 rounded-xl text-lg md:text-xl font-bold transition shadow-2xl hover:bg-emerald-600 border border-emerald-400/50 cursor-pointer"
          >
      ...
      <section
        id="ingenieria"
        className="bg-neutral-950 text-white py-20 md:py-24 px-6 relative overflow-hidden pt-28"
      >
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          >
            <motion.h2
              variants={fadeInUp}
              className="text-xs md:text-sm font-bold text-emerald-500 tracking-widest uppercase mb-2"
            >
              Ingeniería Geodésica
            </motion.h2>
            <motion.h3
              variants={fadeInUp}
              className="text-3xl md:text-5xl font-bold mb-6 md:mb-8 leading-tight"
            >
              Mucho más que una cabaña tradicional.
            </motion.h3>
            <motion.p
              variants={fadeInUp}
              className="text-neutral-300 text-base md:text-lg leading-relaxed"
            >
              La geometría geodésica no es solo estética; es la estructura más
              resistente y eficiente diseñada por el hombre. Su forma esférica
              distribuye las cargas uniformemente, resistiendo vientos extremos,
              mientras que su volumen optimizado reduce el gasto energético en
              calefacción y ventilación en un 30%.
            </motion.p>
          </motion.div>
          ...
          >
            <img
              src="/2.png"
              alt="Estructura de domo geodésico"
      ...
      <section className="py-20 md:py-24 px-6 bg-white rounded-b-[3rem] md:rounded-b-[4rem]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-16">
          ...
          >
            <motion.h2
              variants={fadeInUp}
              className="text-xs md:text-sm font-bold text-emerald-500 tracking-widest uppercase"
            >
              Expertos en Glamping
            </motion.h2>
            <motion.h3
              variants={fadeInUp}
              className="text-3xl md:text-4xl font-bold mb-6"
            >
              GeoCoast: Diseño Sostenible con Rentabilidad Probada.
            </motion.h3>
            <motion.p
              variants={fadeInUp}
              className="text-stone-600 text-base md:text-lg"
            >
              Somos especialistas en la construcción geodésica premium. Creamos
              estructuras llave en mano, diseñadas no solo para desconectar del
              ruido, sino para activar un negocio altamente rentable.
            </motion.p>
            <motion.p
              variants={fadeInUp}
              className="text-stone-600 text-base md:text-lg"
            >
              Un domo VIP bien equipado se arrienda entre $120.000 y $200.000
              por noche en temporada. Con una ocupación media, recuperas tu
              inversión completa en menos de 10 meses.
            </motion.p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 md:mb-20 space-y-3">
            ...
            <p className="text-stone-600 text-lg md:text-xl max-w-2xl mx-auto">
              Desde la compra de tu domo hasta la experiencia resort completa
              lista para facturar.
            </p>
          </div>
          ...
          >
            ...
            <motion.div
              variants={fadeInUp}
              whileHover={{ y: -10 }}
              className="bg-white p-8 md:p-10 rounded-3xl shadow-lg border border-stone-200 flex flex-col h-full"
            >
              <h3 className="text-2xl font-bold mb-2">Básico: DIY Kit</h3>
              <p className="text-stone-500 mb-6 text-sm md:text-base">
                Ideal para constructores y entusiastas.
              </p>
              <div className="text-4xl md:text-5xl font-bold mb-6 text-emerald-600">
                $2.190.000
                <span className="text-xs md:text-sm text-stone-400 font-medium block md:inline">
                  {" "}
                  + IVA
                </span>
              </div>
              <ul className="space-y-4 mb-10 text-stone-700 text-base md:text-lg grow">
                <li className="flex gap-3">
                  <Box className="w-5 h-5 text-emerald-500 shrink-0" /> Kit
                  Geodésico Completo
                </li>
                <li className="flex gap-3">
                  <ShieldCheck className="w-5 h-5 text-emerald-500 shrink-0" />{" "}
                  Cubierta PVC Premium
                </li>
                <li className="flex gap-3">
              ...
              <a href="#agendar" className="block w-full">
                <button className="w-full py-4 rounded-xl border-2 border-emerald-500 text-emerald-600 font-bold hover:bg-emerald-50 transition text-lg">
                  Cotizar Básico
                </button>
              </a>
            </motion.div>
            ...
            >
              <div className="absolute top-0 right-0 bg-emerald-500 text-white text-[10px] md:text-xs font-bold px-3 py-2 rounded-bl-xl rounded-tr-2xl uppercase tracking-wider">
                Más Vendido
              </div>
              ...
              <div className="text-4xl md:text-5xl font-bold mb-6 text-emerald-400">
                $3.290.000
                <span className="text-xs md:text-sm text-neutral-600 font-medium block md:inline">
                  {" "}
                  + IVA
                </span>
              </div>
              <ul className="space-y-4 mb-10 text-neutral-300 text-base md:text-lg grow">
                <li className="flex gap-3">
                  <Zap className="w-5 h-5 text-emerald-400 shrink-0" /> Todo lo
                  del Plan DIY Kit
                </li>
                <li className="flex gap-3">
                  <Zap className="w-5 h-5 text-emerald-400 shrink-0" /> Armado
                  en tu sitio
                </li>
                <li className="flex gap-3">
              ...
              <a href="#agendar" className="block w-full">
                <button className="w-full py-4 rounded-xl bg-emerald-500 text-white font-bold hover:bg-emerald-600 transition shadow-lg shadow-emerald-500/30 text-lg">
                  Cotizar Estándar
                </button>
              </a>
            </motion.div>
            ...
            >
              ...
              <p className="text-stone-500 mb-6 text-sm md:text-base">
                Listo para facturar a precio premium.
              </p>
              <div className="text-4xl md:text-5xl font-bold mb-6 text-emerald-600">
                $5.190.000
                <span className="text-xs md:text-sm text-stone-400 font-medium block md:inline">
              ...
              <ul className="space-y-4 mb-10 text-stone-700 text-base md:text-lg grow">
                <li className="flex gap-3">
                  <HandCoins className="w-5 h-5 text-emerald-500 shrink-0" />{" "}
                  Todo lo del Plan Instalado
                </li>
                <li className="flex gap-3">
                  <HandCoins className="w-5 h-5 text-emerald-500 shrink-0" />{" "}
                  Terraza VIP de madera
                </li>
                <li className="flex gap-3">
                  <HandCoins className="w-5 h-5 text-emerald-500 shrink-0" />{" "}
                  Jacuzzi de madera (Hot Tub)
                </li>
              </ul>
              <a href="#agendar" className="block w-full">
                <button className="w-full py-4 rounded-xl border-2 border-emerald-500 text-emerald-600 font-bold hover:bg-emerald-50 transition text-lg">
          ...
          >
            {[
              ...
              <motion.div
                ...
                className={`${img.span} rounded-2xl overflow-hidden shadow-lg group h-64 md:h-auto`}
              >
                <img
                  src={img.src}
                  alt={`Domo Geodésico real ${index + 1}`}
      ...
      <section
        id="proceso"
        className="bg-neutral-950 text-white py-20 md:py-28 px-6 rounded-t-[3rem] md:rounded-t-[5rem] mt-10"
      >
        <div className="max-w-5xl mx-auto">
          ...
          >
            <motion.h2
              variants={fadeInUp}
              className="text-4xl md:text-5xl font-extrabold mb-12 md:mb-16 leading-tight"
            >
              Del taller a tu Glamping en 4 pasos.
            </motion.h2>

            <motion.div
              variants={staggerContainer}
              className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-8 text-center"
            >
              {[
                {
                  title: "Contacto",
                  desc: "Asesoría técnica y evaluación preliminar.",
                },
                {
                  title: "Visita Física",
                  desc: "Conoces nuestros domos piloto y materiales.",
                },
                {
                  title: "Fabricación",
                  desc: "Estructura geodésica lista en 15 días.",
                },
                {
                  title: "Instalación",
                  desc: "Armado rápido en tu sitio listo para usar.",
                },
              ].map((step, index) => (
                <motion.div
                  key={step.title}
                ...
                >
                  <motion.div
                    ...
                    className="w-16 h-16 bg-neutral-800 rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4 md:mb-6 text-emerald-400 border border-neutral-700 transition"
                  >
                    {index + 1}
                  </motion.div>
                  ...
                  {index < 3 && (
                    <div className="absolute top-1/2 left-full w-full h-0.5 bg-neutral-800 hidden md:block"></div>
                  )}
                </motion.div>
              ))}
            </motion.div>
          ...
          >
            <div className="w-full lg:w-5/12 space-y-6">
              <h3 className="text-3xl md:text-5xl font-extrabold mb-2 leading-tight text-white">
                Agenda tu cita hoy con nosotros
              </h3>
              <p className="text-emerald-400 font-medium tracking-wide uppercase text-sm">
                Visita Piloto Exclusiva
              </p>
              <p className="text-neutral-400 text-base md:text-lg leading-relaxed">
                Ven a conocer la calidad de nuestros materiales, experimenta la
                acústica interior y aclara todas tus dudas técnicas con nuestros
                ingenieros. Sin compromiso.
              </p>
            ...
            <form
              ...
              className="w-full lg:w-7/12 bg-neutral-950 p-6 md:p-8 rounded-2xl border border-neutral-800 shadow-inner"
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="space-y-2 relative">
                  <label className="text-sm font-medium text-neutral-400 pl-1 flex items-center gap-2">
                    <CalendarIcon size={16} /> Elige un Día *
                  </label>
                  <input
                    type="date"
                    required
                    ...
                    onChange={(e) => {
                      ...
                      if (diaSemana === 0) {
                        alert(
                          "Los domingos nuestro showroom está cerrado. Por favor, elige un día de Lunes a Sábado.",
                        );
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    {formData.dia &&
                      new Date(formData.dia + "T00:00:00").getDay() >= 1 &&
                      new Date(formData.dia + "T00:00:00").getDay() <= 5 && (
                        <>
                          <option value="11:00 a 13:00 hrs">
                            Mañana: 11:00 - 13:00 hrs
                          </option>
                          <option value="14:00 a 16:00 hrs">
                            Tarde: 14:00 - 16:00 hrs
                          </option>
                        </>
                      )}

                    {formData.dia &&
                      new Date(formData.dia + "T00:00:00").getDay() === 6 && (
                        <option value="09:00 a 12:00 hrs">
                          Mañana: 09:00 - 12:00 hrs
                        </option>
                      )}
                  </select>
                </div>
              ...
              <p className="text-center text-xs text-neutral-500 mt-4">
                Al presionar, se abrirá WhatsApp con tus datos listos para
                enviar.
              </p>
            </form>
          </motion.div>
      ...
      <footer className="bg-black text-stone-600 py-10 md:py-12 px-6 text-center text-xs md:text-sm border-t border-white/5">
        <p>
          © 2026 GeoCoast. Fabricación Geodésica Premium. Todos los derechos
          reservados.
        </p>
        <p className="mt-2 text-stone-400">
          Desarrollo técnico por{" "}
          <span className="text-white font-bold hover:text-emerald-400 cursor-pointer transition">
            FaroWeb
          </span>
        </p>
      </footer>
